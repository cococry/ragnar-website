...
sudo make clean install"/>
            ...
            <p className="mt-2 text-white">That's basically it. This compiles ragnar with gcc and 
            ...
            <p className="mt-2 text-white">You can also use the installation script in the git repo 
                if you're on Arch that automates the installation process. After installing Ragnar and inside the 
                repo folder run:</p>
            ...
            <p className="mt-2 text-white">If you're on Ubuntu, the Ubuntu install script makes it a lot easier 
