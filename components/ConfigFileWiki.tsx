    ...
    return ( 
        <div className="bg-black p-10 inline-block rounded-xl border border-[3px] border-rounded border-[#1c1c1c] ">
            ...
            <p className="text-white mt-5">Ragnar uses a C header file as a config. 
                ...
                changing macro values. So even if you dont know C, configuring wont be a problem at all.</p>
            ...
            <p className="text-white mt-5">You will find frequently the word DESIGN in Ragnars config file.
                ...
                smooth bar labels you can set DESIGN_ROUND to your label which will round off the label.
            ...
            <p className="text-white mt-5">This section configures the default app commands of the window manager. 
                ...
                values to the the command you want to execute when pressing their keybind. And dont forget to add a & to 
