   ...
   return (
        <div className="bg-black p-10 rounded-xl border border-[3px] border-rounded border-[#1c1c1c] ">
            ...
            <p className="text-white mt-2">The 'BAR_SIZE' macro defines the height of the bar. 'BAR_PADDING_X'
                ...
                color of the bar's border. 'BAR_BORDER_WIDTH' defines the with/size 
                of the bar's border. </p> 
            ...
            <p className="text-white mt-2">This section of the bar's config configures the designs of the bar. 'BAR_LABEL_DESIGN_WIDTH' defines the width of the designs. 'BAR_MAIN_LABEL_DESIGN'
            ...
            <p className="text-white mt-2">The next sub-section defines the colors of the bar's labels. 'BAR_MAIN_LABEL_COLOR' specifies the background color 
            ...
            <p className="text-white mt-2">This section configures the command/main label of the bar. 'BAR_COMMAND_SEPERATOR' is 
                the text/icon that is used to seperate each command (for no seperator pass in " "). 'BAR_COMMANDS_COUNT' specifies the number of commands 
