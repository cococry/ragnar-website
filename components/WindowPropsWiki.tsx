    ...
    return (
        <div className="bg-black p-10 rounded-xl border border-[3px] border-rounded border-[#1c1c1c] ">
            ...
            <p className="mt-2 text-white">The SHOW_DECORATION macro defines if decoration for windows should be enabled or not. 
                The DECORATION_TITLEBAR_SIZE defines the height in pixels of the decorations titlebar. DECORATION_COLOR defines the color 
                of the decorations titlebar. DECORATION_TITLE_COLOR defines the background color of the applications title in the decorations titlebar. 
            </p>
            ...
            <p className="mt-2 text-white">The DECORATION_SHOW_CLOSE_ICON macro defines if 
                the close button should be shown in the decorations titlebar. The DECORATION_CLOSE_ICON macro 
                defines the text/icon that will be used as the close button in the decorations titlebar. DECORATION_CLOSE_ICON_COLOR defines 
            ...
            <p className="mt-2 text-white">The DECORATION_SHOW_MAXIMIZE_ICON macro defines if 
                the maximize button should be shown in the decorations titlebar. The DECORATION_MAXIMIZE_ICON macro 
                defines the text/icon that will be used as the maximize button in the decorations titlebar. DECORATION_CLOSE_MAXIMIZE_COLOR defines 
