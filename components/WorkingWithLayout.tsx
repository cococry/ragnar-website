const WorkingWithLayout = () => {
    return (
        <div className="bg-black p-10 rounded-xl border border-[3px] overflow-hidden border-rounded border-[#1c1c1c] "> 
            ...
            <p className="mt-2 text-white">The conecpt of tiling is simple, its main benefit is ordering windows 
                and a better used screen space. But layouts can also be modified and customized. Thats also a 
            ...
            <p className="text-white mt-2">In Ragnar,the layout can be changed during runtime as you like it. 
                Every window in the layout can change its width and/or height.</p>

            <p className="text-white mt-3">The master window can only change either its width or its height depending 
