        ...
        <footer className="mt-20 m-2">
            ...
            <div className="flex flex-row justify-between items-start">
                <div className="text-gray-400 mt-5">
                    <p>Ragnar is developed by me, @cococry and other contributers on GitHub.</p>
                    <p>The window manager is entirely open source and licensed under the GPL-3.0 License.</p>
                    <p>For questions about the window manager, contact me over Email: githubluca@gmail.com or <a className="text-blue-500" href="https://github.com/cococry/Ragnar/issues/new/choose">write an issue on GitHub.</a></p>
                </div>
