...
export default function Home() {
    ...
    return (
        <>
            <div className="flex items-center w-full flex-col lg:flex-row justify-center md:justify-between gap-[200px] p-6 md:p-40 min-h-screen">        
                <div className="flex flex-col justify-center mt-10 w-full md:w-1/2 items-center md:items-start">
                    ...
                    <div className="max-w-md">
                        ...
                        <div>
                            <div className="relative mt-10 max-w-min p-8 whitespace-nowrap">
